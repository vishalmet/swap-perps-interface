  ...
  return (
    <div className="w-full space-y-2">
            ...
            <TabsContent key={tab.value} value={tab.value} className="min-h-48 p-2 pt-0 space-y-2">
              ...
              <Card className='rounded-[8px] w-full flex flex-row p-2 justify-between items-center'>
                <div className="flex items-center gap-2">
                  ...
                  <span className='text-[var(--color-text-secondary)] text-sm flex items-center'>TP/SL</span>
                </div>
                <div className="text-[10px] flex gap-2">
                  <p className='text-[var(--color-text-tertiary)]'>Long</p>
                  <p className='text-[var(--color-text-tertiary)]'>Short</p>
                </div>
              </Card>
      ...
      <section className='p-2 space-y-2'>
        <p className=' text-[var(--color-text-primary)] font-bold text-sm'>Account Overview</p>
        <div className=" text-[10px] space-y-1">
          <div className=" flex justify-between items-center">
            <p className='text-[var(--color-text-secondary)] underline'>Account Equity</p>
            <p className='text-[var(--color-text-secondary)] font-bold'>$0.00</p>
          </div>
          <div className=" flex justify-between items-center">
            <p className='text-[var(--color-text-secondary)] underline'>Balance</p>
            <p className='text-[var(--color-text-secondary)] font-bold'>$0.00</p>
          </div>
          <div className=" flex justify-between items-center">
            <p className='text-[var(--color-text-secondary)] underline'>Balance available to trade</p>
            <p className='text-[var(--color-text-secondary)] font-bold'>$0.00</p>
          </div>
          <div className=" flex justify-between items-center">
            <p className='text-[var(--color-text-secondary)] underline'>Unrealised PnL</p>
            <p className='text-[var(--color-text-secondary)] font-bold'>$0.00</p>
          </div>
        </div>
      </section>
